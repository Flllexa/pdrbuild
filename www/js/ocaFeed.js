...
function renderEntries(entries) {
    ...
    $.each(entries, function(i, v) {
        s += '<li class="threeTheme"><a href="#contentPage"  class="contentLink" data-entryid="'+i+'">' + '<p style="font-size:15px;font-weight:bold; margin-top:5px;">' + v.title + '</p>' + '<p>' + v.contentSnippet + '</p></a></li>';
    });
    $("#listview").html(s);
